...
pub fn show(app: &mut MyApp, ctx: &egui::Context, ui: &mut egui::Ui) {
    ui.vertical_centered_justified(|ui| {
        ...
        if let Some(picked_path) = app.rx.as_ref().and_then(|rx| rx.recv_timeout(Duration::new(0, 1_000_000)).ok()) {
